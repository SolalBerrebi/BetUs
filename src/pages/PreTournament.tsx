    ...
    <div>
      ...
      <PageTitle
        sub={
          locked
            ...
            : tournamentStart
              ? `Jusqu'à 160 pts en jeu. Ferme dans ${countdown(tournamentStart, now)}.`
              : "Jusqu'à 160 pts en jeu."
        }
      >
        Avant-compétition
      </PageTitle>
      ...
      <Card className="p-5">
        <div className="space-y-5">
          ...
          />
          <div>
            <p className="mb-2 text-[13px] font-medium text-ink-2">Finale · 50 pts (les deux équipes, peu importe l'ordre)</p>
